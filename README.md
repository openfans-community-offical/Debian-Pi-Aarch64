...
*The official version 2.0 is most suggested to upgrade to the latest firmware version:* **"2019-11-10/11"**

*The system version "2019-11-10/11-v2019-2.0-Release" don't need upgrade the kernel and firmware to "2019-11-10/11"*
...
2019-11-10/11-v2019-2.0-Release (recommended update)
```
