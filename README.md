...
**Xfce的图形化无线管理器存在部分兼容问题，点击 [>此处<](./docs/xfce-wifi-settings.md) 查看解决办法**
...
- **基础系统（增强版）** 现已更新至 **2019-08-16-v2019-2.0-RC2-plus++**

- **基础系统** 现已更新至 **2019-08-16-v2019-2.0-RC2**
...
- 4. 接下来在 **"会话和启动窗口"** 选择 **"高级"** 选项

在兼容性部分，勾选 **"桌面启动时启动GNOME服务"** ，如下图所示：

![wifi3](./images/wifi-key/wifi-key3.png)

- 5. 最后重启系统，然后再使用 桌面右上角的 **"NetworkManager"** 管理器连接到你的无线网络
