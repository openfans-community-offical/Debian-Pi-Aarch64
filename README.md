...
- **Deepin** *Aarch64(ARM64)* 深度桌面系统镜像 **已发布！** (基于U4版系统镜像)
...
标准系统镜像默认没有安装 X-WINDOWS 的桌面环境，但是你可以随意自行安装你喜欢的任何桌面环境

点击 **[此处](./README.md#%E5%AE%89%E8%A3%85%E6%A1%8C%E9%9D%A2)** 查看**安装桌面环境**的示例

#### 现在，我们基于U4版的系统镜像，移植了完整的【 深度Deepin 15.5 专业版 】桌面，目前已发布，并提供下载，这是目前第一个基于完整的Debian Aarch64架构而构建的适配于树莓派B/3B+/3A的64位深度ARM64镜像 ！！

#### 有关【 深度Deepin 15.5 ARM64位 专业版 】的详细情况，请前往[此处](./docs/deepin.md)查看
