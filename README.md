...
树莓派64位系统&nbsp;&nbsp;&nbsp;&nbsp;**Debian Stretch Aarch64**

- 2019 新年**新春**特别版 v1.0 **U5** 新版已发布！
...
- **Xface** *Aarch64(ARM64)* 桌面系统镜像 **已发布！** (基于U5版基础系统镜像)

- **Deepin** *Aarch64(ARM64)* 深度桌面系统镜像 **已发布！** (基于U5版基础系统镜像)
...
现在，我们基于自己的U5版基础系统镜像，移植了完整的 **【 深度Deepin 15.5 专业版 】** 桌面，目前已发布，并提供下载，这是目前 **第一个** 基于完整的Debian Aarch64架构而构建的适配于树莓派B/3B+/3A的64位 **深度ARM64镜像** ！！
