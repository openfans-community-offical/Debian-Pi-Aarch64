...
[OPENFANS开源社区](http://www.openfans.org)&nbsp;&nbsp;&&&nbsp;&nbsp;[树莓派爱好者基地]&nbsp;&nbsp;**荣誉出品 - 全网首发 ！！**
...
这是由于你的TF卡的性能**不能足以支撑系统的交换空间I/O**造成的，这种情况下**不建议再使用浏览器播放视频**

编辑你的 **/boot/config.txt** 文件，关闭GPU硬件加速，释放GPU占用的内存空间
