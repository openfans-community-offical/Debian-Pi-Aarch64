...
1. 新增基础镜像U9**加强版**，全面开启Web管理时代，省去终端工具的麻烦，Anytime, Anywhere, 直接使用浏览器登录管理
2. 默认开启容器服务，开箱即用
3. 集成WEB界面的全方位监控
4. 支持WEB界面查看系统状况、硬件信息、情况
5. 支持WEB界面设置主机名
6. 支持WEB界面设置主机域
7. 支持WEB界面设置主机时间、NTP服务器，更新方式
8. 支持WEB界面关机、重启
9. 支持WEB界面系统日志管理
10. 支持WEB界面系统存储及相关外设管理，在线分区、挂载设备
11. 支持WEB界面网络管理
12. 支持WEB界面系统账户管理
13. 支持WEB界面系统服务管理
14. 支持WEB界面系统更新管理
15. WEB界面集成Shell终端，可以在网页上直接进行终端相关操作
